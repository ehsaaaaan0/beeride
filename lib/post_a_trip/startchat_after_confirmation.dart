...
class StartChatAFterConfirm extends StatelessWidget{
          ...
          children: [
            SingleChildScrollView(child: Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children:  [
                ...
                InkWell(onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) =>  TripSetting(),));
              ...
              const SizedBox(height: 10,),
              Center(child: Container(margin: const EdgeInsets.only(left:20,right:20),width: width, height: 50, child:
              ElevatedButton(
                onPressed: () {
                 },
                ...
                child: const Text(
                  "Request Sent",
                  style: TextStyle(fontSize: 17, fontFamily: "poppin_regular"),
                ),
              ),
