              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => RequestATrip(),));
                      },
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Image.asset("assets/images/dots.png", height: 35,width: 28,),
                             Text(
                              "Request a trip",
                              style: pageHeading(),
                            ),
                            Row(
                              ...
                              children: [
                                ...
                                Container(
                                    ...
                                    width: 90,
                                    child: Image.asset(
                                        "assets/images/requestTrip.png", height: 72,width: 95,))
                              ],
                            )
                          ],
                        ),
                    ...
                    child: InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Image.asset("assets/images/pinkdots.png", height: 35,width: 28,),
                            Text(
                              "Post your trip",
                              style: pageHeading(),
                            ),
                            Row(
                              ...
                              children: [
                                ...
                                Container(
                                    ...
                                    width: 90,
                                    child: Image.asset(
                                      "assets/images/postTrip.png", height: 72,width: 95,))
                              ],
                            )
                          ],
                        ),
                    ...
                    child: InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Image.asset("assets/images/bluedots.png", height: 35,width: 28,),
                            Text(
                              "Find your trip",
                              style: pageHeading(),
                            ),
                            Row(
                              ...
                              children: [
                                ...
                                Container(
                                    ...
                                    width: 77,
                                    child: Image.asset(
                                      "assets/images/findTrip.png", height: 72,width: 95,))
                              ],
                            )
                          ],
                        ),
